            ...
            <div className="h-full flex border items-center justify-center">
                <div className="p-padding_base rounded-rounded_primary shadow-md">
                    <div className="flex flex-col items-center">
                        <p className="text-center font-bold text-lg mb-m_base text-primary">Welcome To</p>
                        ...
                        <p className="mt-m_small text-secondary">Sign Up for to access the realm of fitness</p>
                    </div>
